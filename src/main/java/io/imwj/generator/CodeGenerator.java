...
public class CodeGenerator {
     ...
     * 数据库连结信息
     */
    private final String dbUrl = "jdbc:oracle:thin:@127.0.0.1:3306/mysql";
     ...
     * 项目名
     */
    private final String projectName = "DependUtil";
    /**
     * 指定包名
     */
    private final String packageName = "io.imwj.generator";
    /**
     * 作者名
     */
     ...
     * 指定生成的表名
     */
    private final String[] tableNames = new String[]{"表名"};

    /**
     * 项目路径
     */
    private final String path = "E:/idea-work/项目路径/";
